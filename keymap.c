...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        _______,  _______, _______, KC_LCMD, MO(NUMBERS), KC_ENT, KC_ENT,     KC_SPC,  KC_SPC,  MO(SYMB),KC_TAB,  _______, _______, _______
    ),
    ...
    [NUMBERS] = LAYOUT(
        ...
        _______,  _______, _______, _______, _______, _______,     _______,    _______, _______, KC_TAB,  KC_0,    _______, _______, _______
    )
};
